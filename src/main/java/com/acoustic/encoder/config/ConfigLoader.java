package com.acoustic.encoder.config;

import com.acoustic.encoder.model.MusicalCommand;
...
public class ConfigLoader {
    ...
    private final static String CONFIG_FILE_NAME = "encoderMapping.properties";
